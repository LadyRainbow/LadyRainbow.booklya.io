        ...
        popUp: {
            ...
            placeholders: {
                ...
                popUpPasswordRecovery: {
                    file: 'popUp\\blocks\\popUpPasswordRecovery.html',
                    placeholders: {}
                },
                popUpPasswordChange: {
                    file: 'popUp\\blocks\\popUpPasswordChange.html',
                    placeholders: {}
                },
                popUpPersonalInfo: {
                    file: 'popUp\\blocks\\popUpPersonalInfo.html',
                    placeholders: {}
                },
                popUpProtect: {
                    file: 'popUp\\blocks\\popUpProtect.html',
                    placeholders: {}
                },
                popUpSendMessage: {
                    file: 'popUp\\blocks\\popUpSendMessage.html',
                    placeholders: {}
                }
            }
        },
        pagesContent: {
            file: 'user\\blocks\\userOrder.html',
            placeholders: {
                orderedProduct: {
                    file: 'user\\blocks\\orderedProduct.html',
                }
            }
        }
    }
